...
function Post({ post, userData, deletePost }) {
  ...
  return (
    <div className="post p-3 mb-4 rounded shadow-sm text-white">
      ...
      {isDetailOpen && (
        <>
          {console.log("deletePost in PostDetail:", deletePost)}{" "}
          {/* In ra giá trị của deletePost */}
          <PostDetail
            post={post}
      ...
      >
        <div className="d-flex">
          ...
          <button className="btn btn-link mr-3">
            <FontAwesomeIcon icon={faCommentDots} />
            <span className="likes-count" style={{ border: "none" }}>
              {CommentCount}
            </span>
          </button>
          <button className="btn btn-link mr-3" onClick={handleShare}>
            <FontAwesomeIcon icon={faShare} />
            <span className="likes-count" style={{ border: "none" }}>
              {ShareCount}
            </span>
          </button>
          <button className="btn btn-link mr-3" onClick={handleInputtextClick}>
            <FaKeyboard size={20} />
      ...
      <div className="d-flex mt-3">
        ...
        />
        <button
          className="btn-comment-submit ms-2"
